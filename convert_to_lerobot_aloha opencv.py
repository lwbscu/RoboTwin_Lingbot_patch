...
def convert(
    ...
    base_features = {
        "observation.images.cam_high": {
            "dtype": "video", "shape": (3, int(head_hw[0]), int(head_hw[1])), "names": ["c", "h", "w"]
        },
        "observation.images.cam_left_wrist": {
            "dtype": "video", "shape": (3, int(left_hw[0]), int(left_hw[1])), "names": ["c", "h", "w"]
        },
        "observation.images.cam_right_wrist": {
            "dtype": "video", "shape": (3, int(right_hw[0]), int(right_hw[1])), "names": ["c", "h", "w"]
        },
